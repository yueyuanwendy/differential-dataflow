...
fn main() {
    timely::execute_from_args(std::env::args().skip(2), move |worker| {
        ...
        let mut fpv_writer = Writer::from_path("C:/Users/apple/Desktop/output/debug-user-where.csv").expect("Cannot create file");
        let mut fpv_writer2 = Writer::from_path("C:/Users/apple/Desktop/output/debug-user-where-pv-exploded.csv").expect("Cannot create file");
        let mut vis_wrt = Writer::from_path("C:/Users/apple/Desktop/output/variants-in-scope.csv").expect("Cannot create file");
        let mut join_wrt = Writer::from_path("C:/Users/apple/Desktop/output/debug-join2.csv").expect("Cannot create file");
...
//          
     ...
     .inspect(move |x| class_wrt.write_record(&(x.0)).expect("Cannot write to file"));   
        ...
        let mut rdr = ReaderBuilder::new()
            ...
            .from_path("C:/Users/apple/Desktop/db/Freebayes_BatchCalling_c_0071.entire.csv").unwrap();
...
//     //round1 --difference to 160601
//      let mut rdr = ReaderBuilder::new()
//            .has_headers(false)
//            .flexible(true)
//            .delimiter(b'\t')
//            .from_path("C:/Users/apple/Desktop/db/gm-160428-160601_delta-plus.tsv").unwrap();
//
//        for result in rdr.records() {
//            let mut vec: Vec<String> = Vec::new();
//            let record = result.expect("a CSV record");
...
//        let timer = ::std::time::Instant::now();
//        worker.step_while(|| probe.less_than(input3.time()));
//        println!("round 1 Loading finished after {:?}", timer.elapsed());
//        
//   //round2 difference to 160607
//  
//   let mut rdr = ReaderBuilder::new()
//            .has_headers(false)
//            .flexible(true)
//            .delimiter(b'\t')
//            .from_path("C:/Users/apple/Desktop/db/gm-160601-160607_delta-plus.tsv").unwrap();
//
//        for result in rdr.records() {
//            let mut vec: Vec<String> = Vec::new();
//            let record = result.expect("a CSV record");
...
//            .flexible(true)
//            .delimiter(b'\t')
//            .from_path("C:/Users/apple/Desktop/db/gm-160601-160607_delta-minus.tsv").unwrap();
//
//        for result in rdr.records() {
//            let mut vec: Vec<String> = Vec::new();
//            let record = result.expect("a CSV record");
...
//        let timer = ::std::time::Instant::now();
//        worker.step_while(|| probe.less_than(input3.time()));
//        println!("round 2 Loading finished after {:?}", timer.elapsed());
//        
//        //round 3 differenc to 161026
//        let mut rdr = ReaderBuilder::new()
//            .has_headers(false)
//            .flexible(true)
//            .delimiter(b'\t')
//            .from_path("C:/Users/apple/Desktop/db/gm-160607-161026_delta-plus.tsv").unwrap();
//
//        for result in rdr.records() {
//            let mut vec: Vec<String> = Vec::new();
//            let record = result.expect("a CSV record");
...
//            .flexible(true)
//            .delimiter(b'\t')
//            .from_path("C:/Users/apple/Desktop/db/gm-160607-161026_delta-minus.tsv").unwrap();
//
//        for result in rdr.records() {
//            let mut vec: Vec<String> = Vec::new();
//            let record = result.expect("a CSV record");
...
//        let timer = ::std::time::Instant::now();
//        worker.step_while(|| probe.less_than(input3.time()));
//        println!("round 3 Loading finished after {:?}", timer.elapsed());
//        
//     

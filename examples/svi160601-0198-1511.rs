...
//          
     ...
     .inspect(move |x| class_wrt.write_record(&(x.0)).expect("Cannot write to file"));   
        ...
        let mut rdr = ReaderBuilder::new()
            ...
            .from_path("C:/Users/apple/Desktop/db/Freebayes_BatchCalling_B_0198.entire.csv").unwrap();
        ...
        let mut rdr = ReaderBuilder::new()
            ...
            .flexible(true)
            .delimiter(b'\t')
            .from_path("C:/Users/apple/Desktop/db/variant_summary-1511.txt").unwrap();
     ...
     //round1 --difference to 160601
      let mut rdr = ReaderBuilder::new()
            ...
            .flexible(true)
            .delimiter(b'\t')
            .from_path("C:/Users/apple/Desktop/db/cv-1511-1607_delta-plus.tsv").unwrap();
        ...
        for result in rdr.records() {
         ...
         let mut rdr = ReaderBuilder::new()
            ...
            .flexible(true)
            .delimiter(b'\t')
            .from_path("C:/Users/apple/Desktop/db/cv-1511-1607_delta-minus.tsv").unwrap();
   ...
   let mut rdr = ReaderBuilder::new()
            ...
            .flexible(true)
            .delimiter(b'\t')
            .from_path("C:/Users/apple/Desktop/db/cv-1607-1608_delta-plus.tsv").unwrap();
        ...
        for result in rdr.records() {
         ...
         let mut rdr = ReaderBuilder::new()
            ...
            .flexible(true)
            .delimiter(b'\t')
            .from_path("C:/Users/apple/Desktop/db/cv-1607-1608_delta-minus.tsv").unwrap();
       ...
       input1.advance_to(3);
        ...
        let mut rdr = ReaderBuilder::new()
            ...
            .flexible(true)
            .delimiter(b'\t')
            .from_path("C:/Users/apple/Desktop/db/cv-1608-1609_delta-plus.tsv").unwrap();
        ...
        for result in rdr.records() {
         ...
         let mut rdr = ReaderBuilder::new()
            ...
            .flexible(true)
            .delimiter(b'\t')
            .from_path("C:/Users/apple/Desktop/db/cv-1608-1609_delta-minus.tsv").unwrap();

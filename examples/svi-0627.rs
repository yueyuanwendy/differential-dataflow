...
fn main() {
    timely::execute_from_args(std::env::args().skip(2), move |worker| {
        ...
        .inspect(move |x| join_wrt.write_record(&(x.0).1).expect("Cannot write to file"));
      ...
      //.inspect(move |x| class_wrt.write_record(&(x.0).1).expect("Cannot write to file"));    
        ...
        let mut rdr = ReaderBuilder::new()
            ...
            .flexible(true)
            .delimiter(b'\t')
            .from_path("C:/Users/apple/Desktop/db/genemap2-170627-esc.txt").unwrap();
